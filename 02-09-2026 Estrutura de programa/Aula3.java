...
class Aula3 {
    ...
    private static void exercicio5() {
        ...
        System.out.println("Soma dos números informados: " + (numeroum + numerodois + numerotres + numeroquatro));
    ...
    private static void exercicio7() {
        ...
        System.out.println("2 ^ (5/20) + 30 / (15 ^ 2) = " + Math.pow(2, 5.0 / 20.0) + 30.0 / Math.pow(15, 2));
    ...
    private static void exercicio11() {
        ...
        System.out.println("A área do circulo com raio 5 é " + raio * raio * pi);
    }
    ...
    private static void exercicio12() {
        ...
        System.out.println("Sua idade daqui a 30 anos: " + ((anoatual - anonasc) + 30));
    ...
    private static void exercicio13() {
        ...
        System.out.println("A raiz quadrada do número digitado: " + Math.sqrt(numero));
        System.out.println("O número elevado a potência 10: " + Math.pow(numero, 10));
